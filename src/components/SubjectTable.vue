...
<template>
  <div class="flex flex-col items-center justify-center w-11/12 max-w-[1400px] h-[80vh] box-border p-2 rounded-xl shadow-md">
    <div class="h-[80vh] grid overflow-hidden h-80vh gap-x-[1px] gap-y-[1px] w-full grid-cols-[5%_repeat(6,_1fr)_5%] grid-rows-[repeat(15,_1fr)]">
      ...
      <SubjectCell v-for="(subject, index) in subjects" :key="`subject${index}`" :subject="subject" />
    </div>
  </div>
</template>
